...
df_clean.loc[(df_clean['Applicant_Age'] < 25) & (df_clean['Applicant_Marital_Status'].isnull()), 'Applicant_Marital_Status'] = "S"
df_clean.loc[(df_clean['Applicant_Age'] >= 25) & (df_clean['Applicant_Marital_Status'].isnull()), 'Applicant_Marital_Status'] = "M"
